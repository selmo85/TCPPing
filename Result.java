...
/*
   Contains methods for calculations (avg times, msg count, lost msg...)
 */
...
class Result {
    ...
    // reset all values needed for 'per second' calculations
    ...
    public void DisplayMessage() {
        ...
        System.out.println(GetFormattedDate() + " Total msg: " + GetTotalMessageCount() + " Total msg per sec: " + GetPerSecond() + " Max total time: " + GetMaxTotalTime() + newLine +
